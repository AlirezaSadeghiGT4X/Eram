export default function StepsToDownload() {
	return (
		<div className="flex flex-col px-8 mt-8 text-right">
			<p className="text-2xl text-blue-700">مراحل دانلود اپلیکیشن ویندوز</p>
            ...
            <div className="mt-7 flex flex-col gap-6">
				<div className="flex flex-row-reverse text-rose-600">
					<p> : نکته</p>
					<p>
