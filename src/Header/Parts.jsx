...
export default function Parts() {
	...
	return (
		<div className="z-10">
			{headerState === "desktop" ? (
				<div className="hidden flex-row-reverse gap-8 text-lg md:flex">
					{parts.map((part) => (
						<Link
							className="cursor-pointer hover:border-b-2 text-gray-900 hover:pb-2 pb-2 border-sky-100 transition-all duration-75"
