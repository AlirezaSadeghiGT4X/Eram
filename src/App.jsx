...
import AnArticle from "./Articles/AnArticle";
import GeneralTesting from "./GeneralTesting/GeneralTesting";
	...
	return (
		<Router>
			...
			<Routes>
				...
				<Route path="/OnlineTest/Testing" element={<Testing />} />
				<Route path="/GeneralTest" element={<GeneralTest />} />
				<Route path="/GeneralTest/GeneralTesting" element={<GeneralTesting />} />
				<Route path="/AI" element={<AI />} />
				<Route path="/DownloadApp" element={<DownloadWinApp />} />
				<Route path="/Clips" element={<Clips />} />
				<Route path="/Articles" element={<Articles />} />
				<Route path="/AnArticle" element={<AnArticle />} />
